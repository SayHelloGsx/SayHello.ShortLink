    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShortLinkBlockedDomains", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalVisitCount = table.Column<long>(type: "bigint", nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShortLinkLinks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "ShortLinkDailyDimensionStatistics",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShortLinkDailyDimensionStatistics", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShortLinkDailyDimensionStatistics_ShortLinkLinks_ShortLinkId",
                        column: x => x.ShortLinkId,
                        principalTable: "ShortLinkLinks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "ShortLinkDailyStatistics",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShortLinkDailyStatistics", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShortLinkDailyStatistics_ShortLinkLinks_ShortLinkId",
                        column: x => x.ShortLinkId,
                        principalTable: "ShortLinkLinks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShortLinkVisits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShortLinkVisits_ShortLinkLinks_ShortLinkId",
                        column: x => x.ShortLinkId,
                        principalTable: "ShortLinkLinks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShortLinkBlockedDomains_Domain",
                table: "ShortLinkBlockedDomains",
                column: "Domain",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ShortLinkBlockedDomains_IsActive_Domain",
                table: "ShortLinkBlockedDomains",
                columns: new[] { "IsActive", "Domain" });

            migrationBuilder.CreateIndex(
                name: "IX_ShortLinkDailyDimensionStatistics_Dimension_Date",
                table: "ShortLinkDailyDimensionStatistics",
                columns: new[] { "Dimension", "Date" });

            migrationBuilder.CreateIndex(
                name: "IX_ShortLinkDailyDimensionStatistics_ShortLinkId_Date_Dimensio~",
                table: "ShortLinkDailyDimensionStatistics",
                columns: new[] { "ShortLinkId", "Date", "Dimension", "Value" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ShortLinkDailyStatistics_Date",
                table: "ShortLinkDailyStatistics",
                column: "Date");

            migrationBuilder.CreateIndex(
                name: "IX_ShortLinkDailyStatistics_ShortLinkId_Date",
                table: "ShortLinkDailyStatistics",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShortLinkLinks_Status_ExpiresAt",
                table: "ShortLinkLinks",
                columns: new[] { "Status", "ExpiresAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ShortLinkLinks_TenantId_OwnerUserId_IsDeleted_CreationTime",
                table: "ShortLinkLinks",
                columns: new[] { "TenantId", "OwnerUserId", "IsDeleted", "CreationTime" });

            migrationBuilder.CreateIndex(
                name: "IX_ShortLinkVisits_ShortLinkId_VisitedAt",
                table: "ShortLinkVisits",
                columns: new[] { "ShortLinkId", "VisitedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ShortLinkVisits_ShortLinkId_VisitorHash_VisitedAt",
                table: "ShortLinkVisits",
                columns: new[] { "ShortLinkId", "VisitorHash", "VisitedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ShortLinkVisits_VisitedAt",
                table: "ShortLinkVisits",
                column: "VisitedAt");
        }
