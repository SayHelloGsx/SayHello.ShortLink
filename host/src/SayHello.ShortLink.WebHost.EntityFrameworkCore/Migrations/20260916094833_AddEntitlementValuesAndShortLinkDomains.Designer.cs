...
namespace SayHello.ShortLink.WebHost.Migrations
{
    ...
    [Migration("20260916094833_AddEntitlementValuesAndShortLinkDomains")]
    partial class AddEntitlementValuesAndShortLinkDomains
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SayHello.ShortLink.BlockedDomains.BlockedDomain", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SayHello.ShortLink.ShortLinks.ShortLink", b =>
                {
                    ...
                    b.Property<long>("TotalVisitCount")
                    ...
                    b.HasIndex("TenantId", "OwnerUserId", "IsDeleted", "CreationTime");

                    b.ToTable("ShortLinkLinks", (string)null);
                });
            ...
            modelBuilder.Entity("SayHello.ShortLink.ShortLinks.ShortLinkDailyDimensionStatistic", b =>
                {
                    ...
                    b.HasIndex("Dimension", "Date");

                    b.HasIndex("ShortLinkId", "Date", "Dimension", "Value")
                        .IsUnique();

                    b.ToTable("ShortLinkDailyDimensionStatistics", (string)null);
                });

            modelBuilder.Entity("SayHello.ShortLink.ShortLinks.ShortLinkDailyStatistic", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ShortLinkDailyStatistics", (string)null);
                });

            modelBuilder.Entity("SayHello.ShortLink.ShortLinks.ShortLinkVisit", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ShortLinkId", "VisitedAt");

                    b.HasIndex("ShortLinkId", "VisitorHash", "VisitedAt");
            ...
            modelBuilder.Entity("SayHello.ShortLink.ShortLinks.ShortLinkDailyDimensionStatistic", b =>
                {
                    b.HasOne("SayHello.ShortLink.ShortLinks.ShortLink", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SayHello.Subscription.Catalog.SubscriptionProduct", b =>
                {
                    b.HasOne("SayHello.Subscription.Catalog.SubscriptionPlan", null)
                        .WithMany()
                        .HasForeignKey("DefaultPlanId", "Id")
                        .HasPrincipalKey("Id", "ProductId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
