...
public class WebHostEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<WebHostDbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
                 ...
                 * See also WebHostMigrationsDbContextFactory for EF Core tooling. */
            options.UseNpgsql();
        });
