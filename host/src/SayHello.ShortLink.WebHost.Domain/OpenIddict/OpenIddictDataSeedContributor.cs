...
namespace SayHello.ShortLink.WebHost.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("WebHost") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "WebHost", DisplayName = "WebHost API", Resources = { "WebHost" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        //Web Client
        var webClientId = configurationSection["WebHost_Web:ClientId"];
        if (!webClientId.IsNullOrWhiteSpace())
        {
            var webClientRootUrl = configurationSection["WebHost_Web:RootUrl"]!.EnsureEndsWith('/');

            /* WebHost_Web client is only needed if you created a tiered
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["WebHost_Web:ClientSecret"],
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["WebHost_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["WebHost_Swagger:RootUrl"]?.TrimEnd('/');
