...
[DependsOn(
    ...
    typeof(WebHostWebModule),
    typeof(WebHostApplicationTestModule),
    typeof(WebHostEntityFrameworkCoreTestModule)
)]
public class WebHostWebTestModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<IMvcBuilder>(builder =>
        {
            builder.PartManager.ApplicationParts.Add(new CompiledRazorAssemblyPart(typeof(WebHostWebModule).Assembly));
        });
